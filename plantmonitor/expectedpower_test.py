        ...
        result = database.select("""select
            ...
            CASE WHEN irradiation_w_m2 <=0 THEN 0 ELSE (
                ...
                * (
                    ...
                    (temperature_dc - par.standard_conditions_temperature_dc)/10.0 * par.current_temperature_coefficient_mpercent_c/1000./100.0
                )
                * (
                    1 +
                    (temperature_dc/10.0 - par.standard_conditions_temperature_dc/10.0) * par.voltage_temperature_coefficient_mpercent_c/1000.0/100.0
                )
