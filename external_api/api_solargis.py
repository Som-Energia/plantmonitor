    ...
    def __init__(self, api_base_url, api_key):
        ...
        pvsystems = {
            ...
            45: PVSystem(
                ...
                efficiency_type="EfficiencyConstant",
                efficiency_content=100.0,
                limitationACPower_content=1980,
                dcLosses_snowPollution=2.50,
                dcLosses_cables=1.00,
                dcLosses_mismatch=1.50,
                acLosses_transformer=1.10,
            ...
            48: PVSystem(
                ...
                geometry_rotationLimitEast=None,
                geometry_rotationLimitWest=None,
                system_installedPower=302.9,
                system_installationType="ROOF_MOUNTED",
                system_dateStartup="2022-12-01",
                system_selfShading="true",
                module_type="CSI",
                degradation_content=0.52,
                degradationFirstYear_content=2.00,
                PmaxCoeff_content=-0.34,
                efficiency_type="EfficiencyConstant",
                efficiency_content=98.0,
                limitationACPower_content=300,
                dcLosses_snowPollution=7.20,
                dcLosses_cables=1.0,
                dcLosses_mismatch=1.0,
                acLosses_transformer=0.0,
                acLosses_cables=1.0,
            ...
            49: PVSystem(
                ...
                geometry_rotationLimitEast=None,
                geometry_rotationLimitWest=None,
                system_installedPower=138.7,
                system_installationType="ROOF_MOUNTED",
                system_dateStartup="2026-05-01",
                system_selfShading="true",
                module_type="CSI",
                degradation_content=0.55,
                degradationFirstYear_content=2.50,
                PmaxCoeff_content=-0.34,
                efficiency_type="EfficiencyConstant",
                efficiency_content=98,
                limitationACPower_content=100000,
                dcLosses_snowPollution=2,
                dcLosses_cables=1.5,
                dcLosses_mismatch=1,
                acLosses_transformer=0,
                acLosses_cables=1,
                topology_xsi_type="TopologyRow",
                topology_relativeSpacing=2.2,
                topology_type="UNPROPORTIONAL1",
            ),
            # GURB002B Baix Montseny, same values as GURB002A
            50: PVSystem(
                geometry_type="GeometryFixedOneAngle",
                geometry_azimuth=180,
                geometry_tilt=0,
